...
INVOCATION_VNET_START=$(date +%Y%m%dT%H%M%SZ)
...
INVOCATION_VNET_END=$(date +%Y%m%dT%H%M%SZ)

INVOCATION_FARGATE_START=$(date +%Y%m%dT%H%M%SZ)
...
RUN_TASK_RET=$?
INVOCATION_FARGATE_END=$(date +%Y%m%dT%H%M%SZ)
