...
#  Default: ''
c.NotebookApp.notebook_dir = '/home/geot/jupyter'
...
#  password.
#  Default: ''
c.NotebookApp.password = u'argon2:$argon2id$v=19$m=10240,t=10,p=8$lLOoqjqA0ySL9rm3CdAH2A$8zXbs0Ux3Re9fMRC2sNNpQ'
...
#  Choices: any of ['md5', 'sha256', 'sha512', 'sha3_256', 'blake2b', 'sha1', 'blake2s', 'sha3_512', 'sha3_384', 'sha3_224', 'sha384', 'sha224']
#  Default: 'sha256'
